      ...
      <>
         <div className="relative w-full px-4 bg-white">
            <div className="flex items-center justify-between py-2 mx-auto max-w-7xl sm:px-6 lg:px-10">
                     ...
                     <div className="flex flex-col justify-between my-5 lg:flex-row">
                        <div className="">
                           ...
                           <div className="font-bold">
                              Asg <span className="text-yellow">Foods</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               {/* Cart Icon and Location Icon */}
               <div className="flex items-center space-x-6"> {/* Increased space-x-6 */}
                  <Link to={"/contact"}>
                     <HiLocationMarker
               ...
               {/* Sign In Button */}
               <div className="hidden lg:block ml-4"> {/* Added margin-left here */}
                  <Link to={"/signIn"}>
                     <button
                        type="button"
